...
static uint8_t  currentPktRate =1; //  "500Hz", "250Hz", "150Hz", "50Hz", "25Hz", NULL,
  //                                      0       1         2       3       4       5      6      7
static uint8_t  currentPower =1 ;//  "10mW", "25mW", "50mW", "100mW", "250mW", "500mW", "1000mW", "2000mW", NULL,
  //                                    0      1       2        3        4        5        6
static uint8_t currentTlmRatio =0 ;//"OFF", "1:128", "1:64", "1:32", "1:16", "1:8", "1:4", "1:2", NULL,
  //                                   0       1       2       3        4       5     6      7
static uint8_t currentFrequency = 1;//"?", "915 AU", "915 FCC", "868 EU", "433 AU", "433 EU", "2.4G ISM", NULL,
  //                                   0     1         2          3         4         5         6
...
void Crsf_SetRate()
{
  ...
  Usart0TxBuffer_p2M = crsfCmdPacket;
...
void SetRatio()
{
  buildElrsPacket(crsfCmdPacket,ELRS_TLM_RATIO_COMMAND,currentTlmRatio);
  Usart0TxBuffer_p2M = crsfCmdPacket;
  USART_TRANSMIT_BUFFER(CRSF_USART);
}
...
{
// 115K2 8N1
  //USART_SET_BAUD(CRSF_USART, 500000);
  USART_SET_BAUD(CRSF_USART, 400000);
