...
const pm_char STR_SUBTYPE_ELRS_SPI[] PROGMEM = "915AU200""915AU100""915AU50\0""915FC200""915FC100""915FC50\0""868EU200""868EU100""868EU50\0";
//const pm_char STR_SUBTYPE_FRSKYR9_SPI[] PROGMEM = " 915"" 868"" FCC""  EU";

const static RfOptionSettingsvar_t RfOpt_EXLRS_Ser[] PROGMEM = {
/*rfProtoNeed*/PROTO_NEED_SPI  | BOOL1USED | BOOL2USED, //can be PROTO_NEED_SPI | BOOL1USED | BOOL2USED | BOOL3USED
/*rfSubTypeMax*/5,//nb of sub protocols -1
/*rfOptionValue1Min*/-128, // FREQFINE MIN
/*rfOptionValue1Max*/127,  // FREQFINE MAX
/*rfOptionValue2Min*/0,
/*rfOptionValue2Max*/0,
/*rfOptionValue3Max*/3,// rfpower: 0 -> 2dB, 15 -> 17dB
};
...
static void EXLRS_initialize(uint8_t bind)
{
  EXLRS_init();
  if (bind) {
  PROTO_Start_Callback( FRSKYR9_bind_cb);
  } else {
  PROTO_Start_Callback( FRSKYR9_cb);
  }
}

const void *EXPRESSLRS_Cmds(enum ProtoCmds cmd)
{
  switch(cmd) {
  case PROTOCMD_INIT:
    EXLRS_initialize(0);
  ...
  case PROTOCMD_GETOPTIONS:
     SetRfOptionSettings(pgm_get_far_address(RfOpt_EXLRS_Ser),
                          STR_SUBTYPE_ELRS_SPI, //Sub proto
