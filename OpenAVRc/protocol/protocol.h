...
#if (PCM_PROTOCOL==YES)
PROTODEF(PROTOCOL_PCM, INTERNAL, PROTO_PCM_Cmds, STR_PCM ,const pm_char STR_PCM[] PROGMEM = "PCMProtos")
#endif
...
PROTODEF(PROTOCOL_HOTT, CC2500, HOTT_Cmds, STR_HOTT ,const pm_char STR_HOTT[] PROGMEM = "Hott")
//PROTODEF(PROTOCOL_SFHSS, CC2500, SFHSS_Cmds, STR_SFHSS ,const pm_char STR_SFHSS[] PROGMEM = "Sfhss")
//PROTODEF(PROTOCOL_FRSKY_RX, CC2500, FRSKY_RX_Cmds, STR_FRSKY_RX, const pm_char STR_FRSKY_RX[] PROGMEM = "FrSky-RX")
...
PROTODEF(PROTOCOL_MLINK, CYRF6936, MLINK_Cmds, STR_MLINK, const pm_char STR_MLINK[] PROGMEM = "Mlink")
...
//PROTODEF(PROTOCOL_ESKY, NRF24L01, ESKY_Cmds, STR_ESKY, const pm_char STR_ESKY[] PROGMEM = "Esky")
#endif //PROTO_HAS_NRF24L01

#ifdef PROTO_HAS_SX1276
//PROTODEF(PROTOCOL_FRSKYR9, SX1276, FRSKYR9_Cmds, STR_FRSKYR9, const pm_char STR_FRSKYR9[] PROGMEM = "FrskyR9")
